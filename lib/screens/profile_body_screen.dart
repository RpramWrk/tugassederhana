        ...
        children: [
          Container(
            ...
            decoration: const BoxDecoration(
              ...
              color: Color.fromARGB(255, 12, 66, 216),
            ),
          ...
          Text(
            '065120149.rakapramudiya@unpak.ac.id',
          ...
          Container(
            decoration: BoxDecoration(
              color: Color.fromARGB(255, 86, 25, 192),
          ...
          Padding(
            ...
            child: Row(
              children: [
                ...
                const Spacer(),
                Text('Raka Pramudiya Ramadani', style: vkTextLightGrey),
              ],
            ),
          ),
          const Divider(color: Color.fromARGB(255, 245, 136, 4)),
          Padding(
            padding: const EdgeInsets.only(left: 12.0, right: 12.0),
            child: Row(
              children: [
                ...
                const Spacer(),
                Text('Raka', style: vkTextLightGrey),
              ],
            ),
          ),
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Jalan Perumahan Indoggren Blok J2 No.17, RT.8/RW.4, Gunung Sari, Citeureup (Mamah raka/putri), KAB. BOGOR, CITEUREUP, JAWA BARAT, ID, 16811',
